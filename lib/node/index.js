...
exports.readRecursionFileList = exports.serveStatic = exports.mkdirSyncIfNotExists = void 0;
 ...
 */
var mkdirSyncIfNotExists = function (path, recursive) {
    if (recursive === void 0) { recursive = true; }
    if (!fs_1.default.existsSync(path)) {
        try {
            fs_1.default.mkdirSync(path, { recursive: recursive });
        }
        catch (e) {
            console.log(e);
        }
...
exports.mkdirSyncIfNotExists = mkdirSyncIfNotExists;
/**
 * 静态文件服务
