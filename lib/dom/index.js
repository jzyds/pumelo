 ...
 */
function createProgressPopup(titleText) {
    if (titleText === void 0) { titleText = "Downloading..."; }
    var progressPopupId = "progressPopup-".concat((0, common_1.uuidv4)()); // 随机生成ID
    // 动态创建进度弹出框
...
exports.createProgressPopup = createProgressPopup;
/**
