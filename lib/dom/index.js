 ...
 * @returns {Promise}
 */
exports.loadVideo = (file) => new Promise((resolve, reject) => {
    try {
        let video;
 ...
 * @returns {Object}
 */
exports.getVideoInfoAsync = (file) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        let video = yield exports.loadVideo(file);
        return {
